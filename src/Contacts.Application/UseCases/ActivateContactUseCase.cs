...
/// </summary>
public class ActivateContactUseCase
{
    ...
    /// </summary>
    public ActivateContactUseCase(IContactRepository repository, IDateTimeProvider clock)
    {
    ...
    /// <summary>
    /// Ativa o contato informado se ele existir e estiver inativo.
    /// </summary>
